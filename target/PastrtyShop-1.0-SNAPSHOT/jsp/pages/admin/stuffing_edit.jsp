...
<c:set var="currentPage" scope="session" value="jsp/pages/admin/stuffing_edit.jsp"/>
<c:choose>
...
<div class="d-flex mx-5">
    <div class="card m-3 col-sm-4" style="width: 16rem;">
        <div class="card-body">
            <h5 class="card-title">${stuffing.stuffing}</h5>
            <p class="card-text">${stuffing.description}</p>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <form class="col-md-4 offset-md-4 needs-validation" name="loginForm" method="POST" action="${pageContext.request.contextPath}/controller">
            <input type="hidden" name="command" value="edit_parameters_stuffing">

            <div class="form-group col-auto my-3">
                <label for="nameOfStuffing">${nameOfStuffing}</label>
                <input type="text" class="form-control" id="nameOfStuffing" placeholder="${nameOfStuffing}" name="stuffing_name"
            ...
            <div class="form-group col-auto my-3">
                ...
                <textarea type="text" class="form-control" id="stuffingDescription" placeholder="${stuffingDescription}" name="stuffing_description"
            ...
            <c:if test="${edit_stuffing_form_is_null}">
                <div class="invalid-feedback-backend" style="color: red">
                        ${formIsNull}
                </div>
            </c:if>
