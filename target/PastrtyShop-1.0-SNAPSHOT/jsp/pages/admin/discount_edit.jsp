...
<c:set var="currentPage" scope="session" value="jsp/pages/admin/discount_edit.jsp"/>
<c:choose>
    ...
    <div class="container">
        <div class="row">
            ...
            <form class="col-md-4 offset-md-4 needs-validation" name="loginForm" method="POST" action="${pageContext.request.contextPath}/controller">
                <input type="hidden" name="command" value="edit_discount_parameters">

                <div class="form-group col-auto my-3">
                    <label for="nameOfDiscount">${nameOfDiscount}</label>
                    <input type="text" class="form-control" id="nameOfDiscount" placeholder="${nameOfDiscount}" name="discount_name"
                ...
                <div class="form-group col-auto my-3">
                    ...
                    <input type="text" class="form-control" id="valueOfDiscount" placeholder="${discountValue}" name="discount_value"
                           pattern="^[0-9]{1,2}$">
                ...
                <button type="submit" class="btn btn-success my-3">${editDiscount}</button>

                <c:if test="${edit_discount_form_is_null}">
                    <div class="invalid-feedback-backend" style="color: red">
                            ${formIsNull}
                    </div>
                </c:if>
