...
import static com.finalwebproject.pastrtyshop.controller.Parameters.CLIENT_LIST;
import static com.finalwebproject.pastrtyshop.controller.LinksToPages.CLIENTS_ADMIN_PAGE;

public class TakeAllClientsCommand implements Command {
    @Override
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            clientList = clientService.takeAllClients();
            session.setAttribute(CLIENT_LIST, clientList);
        }
