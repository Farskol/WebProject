...
import static com.finalwebproject.pastrtyshop.controller.Parameters.CLIENT_ORDERS;
import static com.finalwebproject.pastrtyshop.controller.LinksToPages.PERSONAL_AREA_PAGE;

import java.util.List;

public class TakeClientOrdersCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try{
            clientOrders = clientService.takeClientOrders(clientId);

            if (!clientOrders.isEmpty()){
                request.setAttribute(CLIENT_ORDERS, clientOrders);
            }
            else{
        ...
        router.setPagePath(PERSONAL_AREA_PAGE);
        return router;
    }
}
