...
import com.finalwebproject.pastrtyshop.controller.command.impl.TakeClientOrdersCommand;
...
@WebFilter(urlPatterns = {"/jsp/pages/personalArea.jsp"})
public class ClientOrdersFilter implements Filter {
    private static final Logger logger = LogManager.getLogger();

    @Override
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        HttpServletRequest request = (HttpServletRequest) servletRequest;
        Command command = new TakeClientOrdersCommand();
        try {
