...
import com.finalwebproject.pastrtyshop.controller.command.impl.TakeAllOrdersCommand;
...
@WebFilter(urlPatterns = {"/jsp/pages/admin/orders_admin.jsp"})
...
public class OrderListFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        Command command = new TakeAllOrdersCommand();
        try {
